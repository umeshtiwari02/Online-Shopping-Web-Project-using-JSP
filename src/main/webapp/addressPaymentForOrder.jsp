...
<h3>Select way of Payment</h3>
 ...
 <option value="Cash on Delivary(CDC)">Cash on Delivery(CDC)</option>
...
<input class="input-style" type="text" name="transactionId" placeholder="Enter Your Transactio ID">
